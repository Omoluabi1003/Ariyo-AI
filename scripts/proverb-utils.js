(function () {
  ...
  const PROVERB_LIBRARY = [
    ...
    {
      yo: 'Àgbà tó bá fẹ́ràn ọmọ, kì í gbé e sórí òkúta.',
      en: 'An elder who loves a child does not place them on a stone.',
    },
  ...
  function isValidCulturalNote(note) {
    return Boolean(
      note && typeof note.yo === 'string' && note.yo.trim() && typeof note.en === 'string' && note.en.trim(),
    );
  }
