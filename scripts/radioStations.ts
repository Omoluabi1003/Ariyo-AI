...
const radioStationsNew: Station[] = [
  ...
  { name: 'RTÉ Radio 1 - Dublin', type: 'Live Radio', url: 'https://www.rte.ie/manifests/radio1.m3u8', thumbnail: 'https://www.rte.ie/radio/static/images/rte-radio-1-logo.png' },
...
const globalStations = (typeof window !== 'undefined' && (window as typeof window & { radioStations?: Station[] }).radioStations) || [];
export const mergedRadioStations: Station[] = mergeRadioStations(globalStations, radioStationsNew);

if (typeof window !== 'undefined') {
  (window as typeof window & { mergedRadioStations?: Station[]; validateRadioStations?: typeof validateRadioStations }).mergedRadioStations =
    mergedRadioStations;
  (window as typeof window & { validateRadioStations?: typeof validateRadioStations }).validateRadioStations = validateRadioStations;
}
