  ...
  const translations = {
    en: {
      ...
      ui: {
        ...
        quickTourSummary: 'Need a quick tour?',
        stayInLoopTitle: 'Stay in the loop',
        stayInLoopDesc: 'We will invite you to enable music alerts after you play or follow creators—no spammy popups.',
        musicPlayerTitle: 'Music Player',
        chooseTrackToStart: 'Choose a track to start playback.',
        artistLabel: 'Artist:',
        releaseYearUnknown: 'Release Year: Unknown',
        retryPlayback: 'Retry playback',
        retryLoadingTrack: 'Retry loading track',
        retry: 'Retry',
        ...
        albumsUnavailable: 'Albums are unavailable. Please refresh the page.',
        albumCoverSuffix: 'Album Cover',
        albumLabel: 'Album',
        newBadge: 'NEW',
        newBadgeTitle: 'Contains freshly added tracks',
        tracksCountLabel: 'Tracks',

        searchSectionTracks: 'Tracks',
        searchSectionStations: 'Stations',
        searchSectionPodcasts: 'Podcasts',
        searchBadgeTrack: 'Track',
        searchBadgeStation: 'Station',
        searchBadgePodcast: 'Podcast',
        searchNoResults: 'No results found.',
        newsOpen: 'Open Naija Vibes News',
        newsName: 'Naija Vibes News',
        newsSubtitle: 'Fresh releases, milestones, and challenges',
        newsIconAlt: 'Naija Vibes News icon',
        newsTagUpdate: 'Update',
        studioOpenInNewTab: 'Open game in a new tab',
